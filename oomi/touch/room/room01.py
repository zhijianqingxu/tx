...
class Testtx(unittest.TestCase):
    ...
    def test08(self):
        self.driver.find_element_by_id('com.fantem.launcher:id/set_select').click()
        self.driver.find_element_by_xpath('//android.widget.ListView[@resource-id=\"com.fantem.launcher:id/r_left_listView\"]/android.widget.RelativeLayout[1]/android.widget.ImageView[1]').click()
        self.driver.find_element_by_id('com.fantem.launcher:id/bt_cancel').click()
        self.driver.implicitly_wait(5)
        self.driver.find_element_by_xpath(
            '//android.widget.ListView[@resource-id=\"com.fantem.launcher:id/r_left_listView\"]/android.widget.RelativeLayout[1]/android.widget.ImageView[1]').click()
    ...
    def test09(self):
        self.driver.find_element_by_xpath('//android.widget.ListView[@resource-id=\"com.fantem.launcher:id/r_left_listView\"]/android.widget.RelativeLayout[2]/android.widget.ImageView[1]').click()
        self.driver.find_element_by_id('com.fantem.launcher:id/bt_cancel').click()
        self.driver.implicitly_wait(5)
        self.driver.find_element_by_xpath(
            '//android.widget.ListView[@resource-id=\"com.fantem.launcher:id/r_left_listView\"]/android.widget.RelativeLayout[2]/android.widget.ImageView[1]').click()
        self.driver.find_element_by_id('com.fantem.launcher:id/updatedevicesandroos_edt_content').clear()
    ...
    def test10(self):
        self.driver.find_element_by_xpath('//android.widget.ListView[@resource-id=\"com.fantem.launcher:id/r_left_listView\"]/android.widget.RelativeLayout[1]/android.widget.ImageView[2]').click()
        self.driver.find_element_by_id('com.fantem.launcher:id/bt_ok').click()
    def test11(self):
        self.driver.find_element_by_xpath('//android.widget.ListView[@resource-id=\"com.fantem.launcher:id/r_left_listView\"]/android.widget.RelativeLayout[2]/android.widget.ImageView[2]').click()

        self.driver.find_element_by_id('com.fantem.launcher:id/bt_cancel').click()
        time.sleep(3)
        self.driver.find_element_by_xpath(
            '//android.widget.ListView[@resource-id=\"com.fantem.launcher:id/r_left_listView\"]/android.widget.RelativeLayout[2]/android.widget.ImageView[2]').click()
    ...
    def test01(self):
        self.driver.find_element_by_id('com.fantem.launcher:id/set_select').click()
        try:
            t1=self.driver.find_element_by_xpath('//android.widget.ListView[@resource-id=\"com.fantem.launcher:id/r_left_listView\"]/android.widget.RelativeLayout[1]/android.widget.ImageView[2]')
        except NoSuchContextException as msg:
            print('查找异常元素%s'%msg)
        else:
            t1.click()
            t2=self.driver.find_element_by_name('该房间无法删除。').text
            print(t2)
            self.driver.find_element_by_id('com.fantem.launcher:id/bt_ok').click()
            '''

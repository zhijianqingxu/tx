...
class Testtx(unittest.TestCase):
    ...
    def test01(self):
        ...
        for i in range(1, 8):
            self.driver.find_element_by_name('空气质量').click()
            print(i)
        for o in range(1, 8):
            self.driver.find_element_by_name('电量').click()
        time.sleep(5)
        self.driver.find_element_by_id('com.fantem.launcher:id/touchUrl').clear()
        self.driver.find_element_by_id('com.fantem.launcher:id/touchUrl').send_keys('http://test.fantem-gateway.com')
        self.driver.find_element_by_id('com.fantem.launcher:id/saveTouchUrl').click()
        self.driver.find_element_by_id('com.fantem.launcher:id/getCubeUrl').click()
        time.sleep(10)
        self.driver.find_element_by_id('com.fantem.launcher:id/cubeUrl').clear()

        self.driver.find_element_by_id('com.fantem.launcher:id/cubeUrl').send_keys('http://test.fantem-gateway.com/')
        self.driver.find_element_by_id('com.fantem.launcher:id/saveCubeUrl').click()
        time.sleep(10)

...
driver.find_element_by_xpath(".//*[@id='_title']").send_keys('touch 丰唐123！#@￥%…&*（）{}|“”：《》？~+和聽到的..吔吥一定會是眞的... Ngáje Ngái')
driver.find_element_by_xpath(".//*[@id='_massage']").send_keys('touch 丰唐123！#@￥%…&*（）{}|“”：《》？~+和聽到的..吔吥一定會是眞的... Ngáje Ngái')

...
driver.find_element_by_xpath(".//*[@id='_title']").send_keys('Delayed30')
driver.find_element_by_xpath(".//*[@id='_massage']").send_keys('Delayed30')
...
driver.find_element_by_xpath("//*[@id='_pushTimeDelay']").click()
driver.find_element_by_xpath("/html/body/app-layout/div/div/div[2]/div/div/form/div[11]/div/label[4]/input").send_keys('30')

...
driver.find_element_by_xpath(".//*[@id='_title']").send_keys('Hello, oomi. Welcome to this big family！All Touch User')
driver.find_element_by_xpath(".//*[@id='_massage']").send_keys('Hello, oomi. Welcome to this big family！All Touch User')
driver.find_element_by_xpath(".//*[@id='_Touch']").click()

driver.find_element_by_xpath("/html/body/app-layout/div/div/div[2]/div/div/form/div[5]/div/label[2]/input").click()

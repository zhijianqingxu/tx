...
driver.find_element_by_xpath(".//*[@id='_title']").send_keys('Hello, oomi. Welcome to this big family！_All User_Gamma ')
driver.find_element_by_xpath(".//*[@id='_massage']").send_keys('Hello, oomi. Welcome to this big family！_All User_Gamma ')
driver.find_element_by_xpath("//*[@id='_All_User']").click()

driver.find_element_by_xpath("/html/body/app-layout/div/div/div[2]/div/div/form/div[4]/div/label[3]/input").click()

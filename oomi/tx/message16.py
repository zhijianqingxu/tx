...
driver.find_element_by_xpath(".//*[@id='_title']").send_keys('Hello, oomi. Welcome to this big family！All Android Client')
driver.find_element_by_xpath(".//*[@id='_massage']").send_keys('Hello, oomi. Welcome to this big family！All Android Client')
driver.find_element_by_xpath("//*[@id='_Android']").click()

driver.find_element_by_xpath("/html/body/app-layout/div/div/div[2]/div/div/form/div[7]/div/label[1]/input").click()

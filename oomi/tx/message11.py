...
driver.find_element_by_xpath(".//*[@id='_title']").send_keys('There is an upgrade package. Do you need to upgrade?')
driver.find_element_by_xpath(".//*[@id='_massage']").send_keys('There is an upgrade package. Do you need to upgrade?')
...
driver.find_element_by_xpath("//*[@id='_MessageTypeO']").click()
driver.find_element_by_xpath("//*[@id='touchOTA']").click()
